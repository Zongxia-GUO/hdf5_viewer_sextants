...
class AboutPage(QWidget):
    ...
    def html_contents() -> str:
        ...
        return (
            "<h1>HDF5 Viewer</h1>"
            "<p>This HDF5 Viewer is designed for convenient browsing and analysis of HDF5 files, "
            "with optimizations specifically tailored for the <b>Soleil SEXTANTS beamline</b>.</p>"
            "<h2>Enhanced by</h2>"
            "<p><b>GUO Zongxia</b><br>"
            "Enhanced with advanced features including:<br>"
            "-X->q conversion for scattering data analysis<br>"
            "-Multi-dataset comparison tools<br>"
            "-Interactive data calculator<br>"
            "-Flexible data visualization controls</p>"
            "<h2>Original Project</h2>"
            "<p>The source code for this HDF5 File Viewer can be found on "
            '<a href="https://github.com/loenard97/hdf5-viewer">GitHub</a>.</p>'
